...
void eu0076 :: solucion(){
	...
	temp_sig_1d_1[0] = 100; // Todo lo hago de atras para adelante, es decir comienzo con 1+1+....+1
	
	temp_2 = 0; // La suma total acumulada

	while( temp_sig_1d_1[99] == 0 ){
		...
		temp_sig_1d_1[0] = 100 - temp_2; // Lo que falte para 100, lo guarda en unidades
...
// cout<<endl<<"---------------";
// 	while( temp_sig_1d_1[7] == 0 ){
// 		while( temp_sig_1d_1[0] >= 2 ){
// 			temp_sig_1d_1[0] = temp_sig_1d_1[0] - 2;
// 			temp_sig_1d_1[1]++;
// 			temp_1++;
// cout<<endl<<temp_sig_1d_1[7]<<" "<<temp_sig_1d_1[6]<<" "<<temp_sig_1d_1[5]<<" "<<temp_sig_1d_1[4]<<" "<<temp_sig_1d_1[3]<<" "<<temp_sig_1d_1[2]<<" "<<temp_sig_1d_1[1]<<" "<<temp_sig_1d_1[0]<<" ";
// 		}
// 		temp_sig_1d_1[0] = 0;
// 		temp_sig_1d_1[1] = 0;
// 		
